...
private:
	...
	T value;
	RecordType type;
	//tombstone, empty, or Normal
	//going to fill it with empty records then override with new Records
...
public:
	...
	~Record(){} // we do not allocate new memory so no destructor needed
